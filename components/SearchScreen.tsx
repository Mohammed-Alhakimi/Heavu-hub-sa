                ...
                <div className="mt-auto space-y-3 pt-4 border-t border-slate-100 dark:border-slate-800">
                  {listing.forSale && (
                    <div className="flex justify-between items-baseline">
                      ...
                      <span className="text-xl font-bold text-slate-900 dark:text-white">{formatCurrency(listing.buyPrice, i18n.language)}</span>
                    </div>
                  )}
                  {listing.forRent && (
                    <div className="flex justify-between items-baseline text-secondary">
                      <span className="text-sm font-medium">Rent</span>
                      <span className="text-base font-bold">{formatCurrency(listing.rentDaily, i18n.language)}<span className="text-xs font-normal text-slate-500 ml-1">/ day</span></span>
                    </div>
                  )}
                </div>
